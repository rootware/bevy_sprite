...
use bevy::{diagnostic::{FrameTimeDiagnosticsPlugin, LogDiagnosticsPlugin}, prelude::*, window::{PresentMode, WindowResolution}};
...
pub const actions : [i32;5] = [0,1,0,2,3];
...
fn sprite_movement(time: Res<Time>, mut sprite_position: Query<(&mut Direction, &mut Transform)>) {
    for (mut logo, mut transform) in &mut sprite_position {
      ...
      //  }
        ...
        let i = ( time.elapsed_secs() as f64/time.delta_secs_f64() ) as usize % 5;
